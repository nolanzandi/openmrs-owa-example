...
This repository contains the testnolan-owa OpenMRS Open Web App.
...
This will create a file called `testnolan-owa.zip` file in the `dist` directory,
...
This will build and deploy the app to the `C:\Users\nolan\openmrs\server\owa`
...
{
  "LOCAL_OWA_FOLDER": "C:\Users\nolan\openmrs\server\owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/testnolan-owa/index.html"
}
```
